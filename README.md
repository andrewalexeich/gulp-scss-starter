...
Что бы указать где создавать блок, можно в консоли прописать команду ```yarn run bem-m my-block``` - для создания БЭМ блока в modules, или команду ```yarn run bem-с my-block``` - для создания БЭМ блока в components
